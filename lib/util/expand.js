...
function expand(config) {
    ...
    if (config.bowerJson && lang.isObject(config.bowerJson.config)) {
        var bowerConfig = config.bowerJson.config;
        config.directory = bowerConfig.directory || config.directory.default;
    }
